...
const MediaContentComponent = ({ mediaType }: { mediaType: 'video' | 'image' }) => {
  ...
  return (
    <div className='min-h-screen'>
      <ScrollExpandMedia
        ...
        textBlend
      >
        <MediaContentComponent mediaType={mediaType} />
      </ScrollExpandMedia>
    </div>
  );
};
  ...
  return (
    <div className='min-h-screen'>
      ...
      <ScrollExpandMedia
        ...
        scrollToExpand={currentMedia.scrollToExpand}
      >
        <MediaContentComponent mediaType={mediaType as 'video' | 'image'} />
      </ScrollExpandMedia>
    </div>
  );
};
